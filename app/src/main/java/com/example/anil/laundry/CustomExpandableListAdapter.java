package com.example.anil.laundry;
...
class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.pricelistgroup, null);
        }
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.price_list_item, null);
        }
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.clothList);
        TextView expandedListTextView1 = (TextView) convertView.findViewById(R.id.clothPrice);
