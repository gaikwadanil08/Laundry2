package com.example.anil.laundry.cloth_price_list.other;
...
public class ClothPriceList_Other extends Fragment {
    View v;
    int counter = 0;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.clothpricelist_other,container,false);
